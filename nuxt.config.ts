  ...
  app: {
		head: {
			...
			meta: [
				...
				{ hid: 'title', name: 'title', content: 'RIKOTTA | Dental Clinic' },
				...
				{ hid: 'og:title', property: 'og:title', content: 'RIKOTTA | Dental Clinic' },
				...
				{ hid: 'og:image', property: 'og:image', content: 'https://dental-project-teal.vercel.app/image.png' },
